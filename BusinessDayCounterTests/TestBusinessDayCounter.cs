...
namespace BusinessDayCounterTests
{
    public class TestBusinessDayCounter
    {
        ...
        /// <summary>
        /// Ensures that the business days between two dates are calculated correctly
        /// given a list of public holidays that can either full or half days for Task 2
        /// </summary>
        [Theory]
        [InlineData("7/10/2013", "9/10/2013", 0.5)]
        [InlineData("24/12/2013", "27/12/2013", 0)]
        [InlineData("7/10/2013", "1/01/2014", 58.5)]
        ...
        /// <summary>
        /// Ensures that the business days between two dates are calculated correctly
        /// given a list of public holidays rules where public holidays can be either full or half days for Task 3
        /// </summary>
        [Theory]
        ...
        //Testing mixed full and half days across different type of public holidays
        //There are 3 types of half public holidays
        //1- Fixed 17/03
        //2- Moving 13/03
        ...
        /// </summary>
        [Theory]
        [InlineData(2021, 6, DayOfWeek.Monday, 2, 0, "14/06/2021")] //2nd Monday of June 2021 AM
        ...
        /// </summary>
        [Theory]
        [InlineData(2021, 1, DayOfWeek.Monday, 5, 0)] //5th Monday of January 2021 12AM
